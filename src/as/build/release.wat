(module
 ...
 (data $11 (i32.const 1632) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\01")
 ...
 (export "solveTSPDP" (func $export:src/as/assembly/index/solveTSPDP))
 (start $~start)
 ...
 (func $export:src/as/assembly/index/solveTSPDP (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
