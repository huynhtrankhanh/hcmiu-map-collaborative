  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item \textbf{Backend stress benchmark} (25{,}461 requests, 0 failures)
          \begin{itemize}
            \item Health check: 3{,}250.83 req/s, p95 11.82 ms
            \item Full-text search: 579.04 req/s, p95 20.97 ms
          \end{itemize}
...
We also ran a backend stress benchmark and recorded 25,461 requests
with zero failures, with p95 latency under 21 milliseconds on the
tested read-heavy scenarios.
}
\end{frame}
